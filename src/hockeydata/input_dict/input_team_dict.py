...
class InputTeamDict():
    ...
    def input_stadium_dict(self, stadium_dict: dict) -> int:
    ...
    def _input_team_info_dict(self, info_dict: dict, stadium_id: int) -> int:
        ...
        team_id = db_pipe.input_data_in_team_table(
            dict_info=info_dict, stadium_id=stadium_id)
        self._input_color_list(
            colour_list=info_dict[COLOUR_LIST], team_id=team_id)
        return team_id
