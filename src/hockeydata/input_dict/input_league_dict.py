...
class InputLeagueDict():
    ...
    def input_league_info_dict(self, info_dict: dict) -> int:
    ...
    def input_league_achievements(self, achiev_dict: dict, league_id: int):
...
class InputLeagueStandings():
    ...
    def _input_league_standings_dict(self, stat_dict: dict, league_id: int):
        ...
        for season in stat_dict:
            ...
            self._input_season_dict(season_dict=season_dict, row_dict = row_dict)
    ...
    def _input_type_dict(self, type_dict: dict, row_dict: dict):
        ...
        for position in type_dict:
            ...
            self._input_position_dict(position_dict=position_dict, row_dict=row_dict)
