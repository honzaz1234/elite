...
class MultiScrapeManager(MultiManager):
    ...
    def __init__(
            self, db_path: str, max_workers: int=4, 
            data: dict[int|str, str]=None):
        super().__init__(db_path=db_path, max_workers=max_workers,data=data)
